...
short_description: Contact-aware humanoid retargeting for thirteen robots
---

# RIMKit

Contact-aware SOMA human-motion retargeting for G1, H1, H2, R1, K1, Apollo,
Oli, N1, ADAM Lite, T1, PM01, Asimov-1, and X2-Ultra.

Upload a Kimodo SOMA `.npz` or GEM-X SOMA `.pt`, choose a humanoid from the
thirteen-model target selector, and run RIMKit's complete DMR → CoRe pipeline. The
